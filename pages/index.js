    ...
    <>
      ...
      <div className="flex flex-row justify-center items-center w-full h-full bg-pink-200 p-10 drop-shadow-xl">
        <div className="w-2/3 h-64 bg-gradient-to-r from-pink-300 to-pink-200 drop-shadow-xl rounded-full text-center transition-all duration-300">
          <h1 className="p-20 tracking-wide text-8xl font-bold text-white uppercase drop-shadow-lg">Güzel sevgilimm</h1>
        </div>
      </div>

      <div className="flex flex-row items-center justify-evenly w-full h-96 bg-pink-50">
        <CommentedImage src='/marina1.jpg' text="Çoookk güzelsin sennn"/>
        <CommentedImage src='/marina2.jpg' text="Birlikte ne kadar mükemmelizz"/>
        <CommentedImage src='/marina3.jpg' text="Muhteşemsin senn"/>
      </div>

      <div className="text-center w-full h-64 bg-pink-200 drop-shadow-xl">
        <h1 className="p-20 tracking-wide text-6xl font-bold text-pink-400 uppercase drop-shadow-xl">Meleğimmm</h1>
      </div>
      ...
      <div className="flex flex-col items-center text-center w-full h-96 bg-pink-50 p-10">
        <div className="flex flex-row items-center text-center w-full h-5/6 bg-pink-50">
          <h1 className='w-1/3 text-pink-300 font-bold text-6xl'>Bennn</h1>
          ...
          <h1 className='w-1/3 text-pink-300 font-bold text-6xl'>Sanaa</h1>
        </div>
        <h1 className="w-full h-1/4 text-pink-300 font-bold text-6xl uppercase">Çoookk aşığımmm</h1>
      </div>

      <div className="text-center w-full h-64 bg-pink-200 drop-shadow-xl">
        <h1 className="p-20 tracking-wide text-6xl font-bold text-pink-400 uppercase drop-shadow-xl">Veee</h1>
      </div>

      <CornyQuestion 
        question="O kadar güzelsin ki aşkım sen yanii bu dünyadan değilsin bence"
      ...
      <div className="flex flex-row justify-around items-center text-center w-full h-96 bg-pink-200 p-5">
        <h1 className='w-2/3 text-pink-400 font-bold text-6xl'>Ve ve veeee</h1>
      </div>

      <div className="flex flex-row justify-around items-center text-center w-full h-96 bg-pink-50 p-5">
        <h1 className='w-2/3 text-pink-300 font-bold text-6xl'>vee</h1>
      </div>

      <CornyQuestion 
        question="Dünya üzerindeki evrendeki en güzel kızsın harikasın yani sennn"
      ...
      <CornyQuestion 
        question="Kusursuz güzelliğin beni mest ediyor gözlerimi kamaştırıyor"
      ...
      <CornyQuestion 
        question="Ve söylemek istediğim bir şeyy"
      ...
      <div className="flex flex-row justify-around items-center text-center w-full h-96 bg-pink-50 px-5 pt-5">
        <h1 className='w-2/3 text-pink-400 font-bold text-6xl'>Evlensek çooookk güzel olur hayatımm di miiii🥹💘</h1>
      </div>
...

      {
        ...
        <div className="flex flex-col justify-around items-center text-center w-full h-[58em] bg-pink-200 p-5">
          <h1 className='w-2/3 text-pink-400 font-bold text-6xl'>Balımla evlilik kartımızz</h1>
          <div className="flex flex-col items-center gap-5 text-center w-3/4 h-5/6 bg-white p-5 rounded-3xl shadow-xl">
            ...
            <h3 className='w-2/3 text-black opacity-90 font-bold text-2xl'>
              Sürpriz sürpriz bir sahil kenarı romantik bir yerr
            </h3>
            <h2 className='w-2/3 text-black opacity-75 font-bold italic text-2xl'>
              Time
            </h2>
            <h3 className='w-2/3 text-black opacity-90 font-bold text-2xl'>
              Sürpriz sürprizz ileride  olucak kesssinlikle olucakkk
            </h3>
            <h2 className='w-2/3 text-black opacity-75 font-bold italic text-2xl'>
              Events
            </h2>
            <h3 className='w-2/3 text-black opacity-90 font-bold text-2xl'>
              • Sade canlı müzik müzikk • Meleğimle evetttt diceğimiz an • Dans danss• Çoook güzel bir düğünnn •
            </h3>
            <img className="h-24" src="https://cdn.pixabay.com/photo/2018/02/19/20/28/abstract-3166168__480.png" alt=""/>
          </div>
        </div>
